...
### [Accrued Expenses](terms/accrued-expenses.md)
Expenses that have been incurred but not yet paid for.

### [Accrual Method Accounting](terms/accrual-method-accounting.md)
...
### [Google Sheets](terms/google-sheets.md)
A spreadsheet program included as part of the free, web-based Google Docs Editors suite.

### [Gross Profit](terms/gross-profit.md)
The profit a company makes after deducting the costs associated with making and selling its products, or the costs associated with providing its services.

### [Gross Profit Margin](terms/gross-profit-margin.md)
...
### [Petty Cash](terms/petty-cash.md)
A small amount of cash kept on hand to pay for minor expenses.

### [Prepaid Expenses](terms/prepaid-expenses.md)
...
### [Tangible Assets](terms/tangible-assets.md)
...
### [Working Capital](terms/working-capital.md)
The difference between a company's current assets and current liabilities.

### [Write-Off](terms/write-off.md)
A reduction in the value of an asset or earnings by the amount of an expense or loss.

## X

### [XLS/XLSX File](terms/xls-xlsx-file.md)
